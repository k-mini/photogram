...
function subscribeInfoModalOpen(pageUserId) {
	...
	$.ajax({
		...
		console.log("구독정보 불러오기 오류ㅠ",error);
	});
}
...
function profileImageUpload(pageUserId, principalId) {
	...
	$("#userProfileImageInput").on("change", (e) => {
		...
		// formData는 사진 이나 파일 + 일반적인 데이터를 감싸는 용도 (일반적인 텍스트데이터는 그냥 serialize() 처리)
		...
		$.ajax({
			...
			processData : false, // 필수 : contentType을 false로 줬을 때 데이터 타입이 QueryString 자동 설정됨. 이걸 해제
